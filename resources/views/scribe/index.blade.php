...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "https://starter.test";
        var useCsrf = Boolean();
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTv1-auth-login">POST v1/auth/login</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTv1-auth-register">
                                <a href="#authentication-POSTv1-auth-register">POST v1/auth/register</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: October 3, 2024</li>
    </ul>
</div>
...
<p>This is the OpenAPI Specification for the API Starter application.</p>
<aside>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
    ...
    <p>A collection of Authentication specific endpoints.</p>

                                <h2 id="authentication-POSTv1-auth-login">POST v1/auth/login</h2>
...
<div class="bash-example">
    ...
    "https://starter.test/v1/auth/login" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"email\": \"jon.snow@thewall.io\",
...
$url = 'https://starter.test/v1/auth/login';
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="jon.snow@thewall.io"
               data-component="body">
    <br>
<p>The email of the authenticating user. Must be a valid email address. Example: <code>jon.snow@thewall.io</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The password of the authenticating user. Example: <code>super-secret-password</code></p>
        </div>
        </form>

                    <h2 id="authentication-POSTv1-auth-register">POST v1/auth/register</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://starter.test/v1/auth/register" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"Jon Snow\",
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://starter.test/v1/auth/register';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTv1-auth-register"
               value="Jon Snow"
               data-component="body">
    <br>
<p>The name of the registering user. Must be at least 2 characters. Must not be greater than 255 characters. Example: <code>Jon Snow</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The email of the registering user. Must be a valid email address. Must not be greater than 255 characters. Example: <code>jon.snow@thewall.io</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The password of the registering user. Must be at least 8 characters. Example: <code>super-secret-password</code></p>
        </div>
        </form>
